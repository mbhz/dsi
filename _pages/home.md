...
- Необходима SD карта или microSD с переходником под SD (обычно карта поставляется в комплекте с консолью)
	- Карта памяти дожна быть в формате FAT32. Отформатируйте Вашу карту согласно [инструкции](https://customfw.xyz/format_sd){:target="_blank"}
- Модификация происходит используя Memory Pit - наиболее простой и удобный эксплоит приложения Камера DSi, подходящей для консолей всех регионов на любых версиях ПО.
